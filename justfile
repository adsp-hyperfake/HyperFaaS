...
run-local-leaf:
    ...
    go run cmd/leaf/main.go --address=0.0.0.0:50050 --log-level=debug --log-format=dev --worker-ids=127.0.0.1:50051 --scheduler-type=mru --database-address=http://localhost:8999
