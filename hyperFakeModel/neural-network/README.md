...
Options:
  --dbs-path PATH               Path to directory containing database files
                                [default: /path/to/HyperFaaS/hyperFakeModel/
                                training_dbs]
  --target-path PATH            Target path for saving the trained model
                                [default: /path/to//HyperFaaS/hyperFakeModel/
  ...
  --table-name TEXT             The dbs table name containing the training
...
Options:
  --dbs-path PATH         Path to directory containing database files
                          [default: /path/to/HyperFaaS/hyperFakeModel/
                          training_dbs]
  --target-path PATH      Target path for saving the trained model  [default:
                          /path/to//HyperFaaS/hyperFakeModel/neural-network/
                          models]
